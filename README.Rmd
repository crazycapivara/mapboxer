...
The mapboxer R library makes [Mapbox GL JS](https://docs.mapbox.com/mapbox-gl-js/api/),
...
You only need a Mapbox access token if you want to use styles from Mapbox.
By default mapboxer uses [Carto vector styles](https://github.com/CartoDB/basemap-styles)
as basemaps and it is also possible to use raster tiles or a background color.
