...
By default __mapboxer__ uses [Carto vector styles](https://github.com/CartoDB/basemap-styles)
for basemaps and it is also possible to use raster tiles or a background color.
